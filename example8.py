...
team_name = 'Percentage'
strategy_name = 'Percentage'
strategy_description = 'Percentage of a time do this'
...
def move(my_history, their_history, my_score, their_score):
  ...
  U ||----------||----------||----------||----------||----------||----------|| 
    ...
    # If the other player has played paper or this is the last half of the game, 
    
    if 'p' in their_history or len(their_history)>100: 
        return 's'               # Scissors.
    else:
        return 'k'         # but 90% of the time play SPOCK