...
team_name = 'look back'
strategy_name = 'look back'
strategy_description = 'See what they did and counter'
...
def move(my_history, their_history, my_score, their_score):
  ...
  U ||----------||----------||----------||----------||----------||----------|| 
    ...
    if len(my_history)==0: # It's the first round; rock.
        return 'r'
    elif my_history[-1]=='r' and their_history[-1]=='p':
        return 's' # if I played rock and the played paper, then I will play scissors,
    else:
        return 'r' # otherwise play rock if I am winning.